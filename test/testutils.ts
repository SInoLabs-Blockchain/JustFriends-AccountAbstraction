...
export function getAccountInitCode(owner: string, factory: SimpleAccountFactory, salt = 0): BytesLike {
  console.log("🚀 ~ file: testutils.ts:96 ~ getAccountInitCode ~ factory.address:", factory.address);

  console.log(
    "🚀 ~ file: testutils.ts:96 ~ getAccountInitCode ~ factory.interface.encodeFunctionData('createAccount', [owner, salt]):",
